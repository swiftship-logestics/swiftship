...
<div class="flex justify-between w-full md:pb-[17px] pb-[15px]">
  <div class="flex items-center pt-[8px]">
    <NuxtLink v-if="menuItems.logo" to="/" class="font-bold text-xl md:max-w-[100%] max-w-[86px] md:min-w-[auto] min-w-[86px] md:max-h-[none] max-h-[80px] md:min-h-[auto] min-h-[80px] object-cover">
      <!-- {{ menuItems.logo.text }} -->
        <img src="/images/swift-logo.svg" class="" />
    </NuxtLink>
  </div>
  ...
  <div class="w-full md:pl-[46px] pl-[40px] md:block flex justify-end items-center" v-if="menuItems.button">
    <div class="top_bar md:flex hidden items-center justify-end gap-[26px] py-[12px] bg-[#EEF9FF]">
      <NuxtLink class="flex items-center gap-[10px] text-[#141416] font-[PingLCG] font-[700] text-[14px] leading-normal cursor-pointer">
        <span class="icon">
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1.86667 12.4997L10.6667 3.69967V11.583H12.5V0.583008H1.5V2.41634H9.38333L0.583334 11.2163L1.86667 12.4997Z" fill="#141416"/>
          </svg>
        </span>
        <span>
          Track your order
    ...
    <div class="md:flex items-center justify-between w-full pt-[16px] hidden">
      <nav class="flex flex-wrap lg:gap-[42px] gap-[25px] items-center main_menu">
        <NuxtLink
          ...
          :key="item.href"
          :to="getMenuLink(index, item.href)"
